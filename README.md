...
Here are some repositories I've worked on with my team — real code, real learning, and real fun! 

- 🔗 [MiniSocial App - Java EE Web App](https://github.com/Afnan-Sayed/Mini-Social)
- 🔗 [LMS App - Spring App](https://github.com/Afnan-Sayed/LMS-Maintenance-Project)
